...
\begin{tabular}{|c|l|l|}
    ...
    0100 & NEW ALIVE RESPONSE & Enhetstyp hos mottagare och nytt ID \\
    0101 & RESET UNIT & ... \\
...
\subsubsection{Dörrenhet}
Dörrenhetens implementation har uppnåt de delmål som sattes upp i början av projektet. Enheten kan hantera ett flertal dörrar, för varje dörr ska tröskelvärdet kunna justeras via ett CAN-meddelande från centralenheten. Den kan larma lokalt med en röd lysdiod i fall dörren är öppen och dess standard tidsintervall överskrids, efter tidsintervallet för globalt larm överskrids skickas ett CAN-meddelande till centralenheten. Enheten kan svara på de periodvisa \emph{ALIVE} meddelanden som den får från centralenheten samt avlarmas med ett \emph{STOP ALARM} meddelande.
