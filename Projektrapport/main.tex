...
Centralenheten är häjrnan av systemet. Enhetens huvudsakliga uppgiften är att hålla en ständigt kommunikation mellan centralenheten och inkopplade enheterna. Kommunikationen kommer att omfatta ACK-, larm-, och konfigurationsmeddelanden. Ack meddelanden är ett sätt att se till att kopplade enheterna verkligen mottagar meddelande från centralenheten och vice versa. Detta innebär att vid kommunikation av två enheterna, enhet A och B, förväntas då ack-meddelande från enhet B, vilket signilerar att meddelanden har nått destinationen. Dessutom inte alla typer av meddelande skickar ack, exempelvis meddelandtyp ``LIFESIGN'' och ``ack'' kräver ingen ack-respons när de skickas till andra enheterna, detta för att undvicka skapa oändlig loop (Figur 5). En ständig kommunikation innebär att centralenheten förvänta sig att inkopplade enheterna skickar meddelande med typ "Life Sign" kontineurligt i en förbestämd tid intervall av 50ms. 
