...
I detta avsnitt redovisas resultatet av genomförd verifiering av systemet och dess olika delar

\subsection{Periferienheter}
\subsubsection{Dörrenhet}
Dörrenheten implementerades enligt målet korrekt. Den kunde larma lokalt 
\subsubsection{Sensorenhet}
